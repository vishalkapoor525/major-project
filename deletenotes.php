...
<link href="//cdn.datatables.net/1.10.23/css/jquery.dataTables.min.css" rel="stylesheet">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="Notes.php">Delete Records</a>
...
<h4 style = "text-align : center">You can delete your Records permanently</h4>
...
<br><br><br>
  ...
  //echo "serial number is ".$serial;
    ...
    if($_SERVER['REQUEST_METHOD']=="POST")
    {
        ...
        $desc = $_POST['desc'];
        $serial = $_POST['Sno'];
        $sql = "DELETE FROM notes WHERE `Sno` = '$serial'";
        $result = mysqli_query($conn,$sql);
        if($result)
        {
            echo '<br><br><div class="alert alert-success alert-dismissible fade show" role="alert"><strong>SUCCESS</strong> <br> Note has been deleted successfully<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
        }
        else
        {
            echo '<br><br><div class="alert alert-WARNING alert-dismissible fade show" role="alert"><strong>WARNING</strong> <br> Sorry We are facing some technical issue <br> please try again later <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
        }
    }
...
<div class="mb-3">
    <label for="exampleInputEmail1" class="form-label"><h3>Notes title</h3></label>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label"><h3>Description</h3></label>
